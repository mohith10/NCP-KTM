             ...
             <div class="tab-pane fade" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-effect-tab">
              	<div class="dropdown">
					<p class="dropbtn">Update Password</p>
						<form action="Customize_Package_Profile.jsp" onsubmit="check_password()">
						<div class="form-field">
	              					<div class="icon"><span class=""></span></div>
					                <input type="text" class="form-control" required="" name="check_password" placeholder="Enter Current Password">
					              </div>
								  <br>
