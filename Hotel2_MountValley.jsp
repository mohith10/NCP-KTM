...
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('http://shyamjitours.in/blog/wp-content/uploads/2018/08/tyy.jpg');">
          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				...
          				<div class="item">
          					<div class="hotel-img" style="background-image: url('https://media.cntraveller.in/wp-content/uploads/2017/10/Blackberry.jpg');"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url('https://blessingsonthenet.com/img/uploads/hotels/aim_bn_1308806846.jpg');"></div>
          				</div>
          			</div>
          		</div>
          		<div class="col-md-12 hotel-single mt-4 mb-5 ftco-animate">
          			<span>Our Best hotels &amp; Rooms</span>
          			<h2>Mount. Valley Pallakadki</h2>
          			<p class="rate mb-5">
          				<span class="loc"><a href="#"><i class="icon-map"></i>Behind Pallivasal Tea Factory, Pallivasal Estate (PO), Palakkad, Kerala 685612</a></span>
          				<span class="star">
    							<i class="icon-star"></i>
    							<i class="icon-star"></i>
    							<i class="icon-star"></i>
          		...
          		<div class="col-md-12 hotel-single ftco-animate mb-5 mt-4">
          			...
          			<div class="block-16">
		              <figure>
		                <img src="http://dreamkeralapackages.com/Hotel/Hotels/22s[105].jpg" alt="Image placeholder" class="img-fluid">
          			...
          			<div class="row">
          				<div class="col-md-4">
				    				<div class="destination">
				    					<a href="hotel-single.html" class="img img-2" style="background-image: url('https://s-ec.bstatic.com/images/hotel/max1024x768/731/73118462.jpg');"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="hotel-single.html"> Deluxe Cottage</a></h3>
						    						<p class="rate">
						    							<i class="icon-star"></i>
						    							<i class="icon-star"></i>
						    							<i class="icon-star"></i>
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					<a href="hotel-single.html" class="img img-2" style="background-image: url('https://images.oyoroomscdn.com/uploads/hotel_image/42030/xlarge/3273f03a218a04da.jpg');"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="hotel-single.html">Premium Cottage</a></h3>
						    						<p class="rate">
						    							<i class="icon-star"></i>
						    							<i class="icon-star"></i>
						    							<i class="icon-star"></i>
					    						...
					    						<div class="two">
					    							<span class="price per-price">Rs. 3040<br><small>/night</small></span>
				    							</div>
				    						</div>
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					<a href="hotel-single.html" class="img img-2" style="background-image: url('http://www.bestwesternplusmeridian.com/Content/images/Queen-Room.jpg');"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
          			...
          			<div class="fields">
			              ...
			              <div class="col-md-6">
				              <div class="form-group">
				                <input type="hidden" class="form-control checkin_date" value="Mount. Valley Hotel" name="place" placeholder="Date from">
				              </div>
			              </div>
						  <div class="col-md-6">
				              <div class="form-group">
