...
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('https://wallpaperstock.net/wallpapers/thumbs1/47050wide.jpg');">
  ...
  <script>alert("Your booking is done and added to the cart. Go to your profile and do the payment.")</script>
  </body>
</html>