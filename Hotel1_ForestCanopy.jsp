...
<html lang="en">
  <head>
    <title>Forest Canoppy-KTC</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('https://seoimgak.mmtcdn.com/blog/sites/default/files/image_79.jpg');">
          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="hotel-img" style="background-image: url('https://s-ec.bstatic.com/images/hotel/max1024x768/703/70370578.jpg');"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url('https://media-cdn.tripadvisor.com/media/photo-s/0f/87/a3/65/forest-canopy.jpg');"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url('https://www.indiashotels.com/webadmin/hotelgallery/69364035.jpg');"></div>
          				</div>
          			</div>
          		</div>
          		<div class="col-md-12 hotel-single mt-4 mb-5 ftco-animate">
          			<span>Our Best hotels &amp; Rooms</span>
          			<h2>Forest Canoppy, Idukki</h2>
          			<p class="rate mb-5">
          				<span class="loc"><a href="#"><i class="icon-map"></i> NH 220, Kottayam - Kumily Road, Chalimada Junction, Idukki, Kerala 685509</a></span>
          				<span class="star">
    							<i class="icon-star"></i>
    							<i class="icon-star"></i>
    							<i class="icon-star"></i>
          		...
          		<div class="col-md-12 hotel-single ftco-animate mb-5 mt-4">
          			...
          			<div class="block-16">
		              <figure>
		                <img src="https://s-ec.bstatic.com/images/hotel/max1024x768/703/70370578.jpg" alt="Image placeholder" class="img-fluid">
          			...
          			<div class="row">
          				<div class="col-md-4">
				    				<div class="destination">
				    					<a href="hotel-single.html" class="img img-2" style="background-image: url('https://media-cdn.tripadvisor.com/media/photo-s/0a/86/66/24/forest-canopy.jpg');"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
					    						...
					    						<div class="two">
					    							<span class="price per-price">Rs. 2000<br><small>/night</small></span>
				    							</div>
				    						</div>
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					<a href="hotel-single.html" class="img img-2" style="background-image: url('https://imgcld.yatra.com/ytimages/image/upload/t_hotel_tg_details_seo/v1538739853/Hotel/Thekkady/00055535/Forest_royal_oak_2_bed_UG47WT.jpg');"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
				    			...
				    			<div class="col-md-4">
				    				<div class="destination">
				    					<a href="hotel-single.html" class="img img-2" style="background-image: url('https://media-cdn.tripadvisor.com/media/photo-s/0a/27/4c/61/forest-canopy.jpg');"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="hotel-single.html">The Royal Oak</a></h3>
						    						<p class="rate">
						    							<i class="icon-star"></i>
						    							<i class="icon-star"></i>
						    							<i class="icon-star"></i>
